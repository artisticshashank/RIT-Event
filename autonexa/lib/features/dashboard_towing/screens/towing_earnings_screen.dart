...
class TowingEarningsScreen extends ConsumerStatefulWidget {
  const TowingEarningsScreen({super.key});

  @override
  ConsumerState<TowingEarningsScreen> createState() =>
      _TowingEarningsScreenState();
}

class _TowingEarningsScreenState extends ConsumerState<TowingEarningsScreen> {
  ...
  Widget build(BuildContext context) {
    final earningsAsync = ref.watch(towingEarningsProvider);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.invalidate(towingEarningsProvider),
          ),
        ],
      ),
