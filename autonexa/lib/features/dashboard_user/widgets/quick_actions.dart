...
class QuickActions extends StatelessWidget {
              ...
              _buildActionItem(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const MechanicsSearchScreen(),
                    ),
                  );
                },
              ),
  ...
  Widget _buildActionItem(
    ...
    return GestureDetector(
      ...
      child: Container(
        width:
            (MediaQuery.of(context).size.width - 48 - 32) /
            3, // Screen width - horizontal padding - gap between items
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(icon, color: Pallete.secondaryColor, size: 28),
            ),
