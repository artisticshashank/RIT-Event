...
class MarketTabView extends ConsumerWidget {
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                _buildCategoryPill(context, 'Brakes', Icons.warning_amber_rounded, false),
                const SizedBox(width: 12),
                _buildCategoryPill(context, 'Interior', Icons.airline_seat_recline_normal, false),
              ],
            ),
          ),
          const SizedBox(height: 24),
          ...
          Padding(
            ...
            child: partsAsync.when(
              data: (parts) {
                ...
                final List<SparePartModel> displayParts = parts.isEmpty ? _getDummyParts() : parts;
  ...
  Widget _buildCategoryPill(BuildContext context, String label, IconData icon, bool isSelected) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
      decoration: BoxDecoration(
        color: isSelected ? Pallete.secondaryColor : Theme.of(context).cardColor,
        borderRadius: BorderRadius.circular(100),
      ),
      child: Row(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: isSelected ? Colors.white : (isDark ? Colors.white70 : Pallete.textColor),
            ),
          ),
        ],
      ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: const Icon(
                      Icons.favorite,
                      size: 16,
                      color: Colors.white, // As per image it's just white heart or grey if unselected
                    ),
                  ),
                ),
              ],
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.star, color: Pallete.secondaryColor, size: 12),
  ...
  List<SparePartModel> _getDummyParts() {
    return [
      SparePartModel(id: '1', sellerId: 's1', name: 'Performance Brakes', price: 89.99),
      SparePartModel(id: '2', sellerId: 's2', name: 'V8 Spark Plugs (Set)', price: 12.50),
      SparePartModel(id: '3', sellerId: 's1', name: 'LED Headlight Kit', price: 145.00),
      SparePartModel(id: '4', sellerId: 's3', name: 'Sport Air Filter', price: 45.00),
      SparePartModel(id: '5', sellerId: 's2', name: 'MaxPower Battery', price: 199.99),
      SparePartModel(id: '6', sellerId: 's1', name: 'Synthetic Motor Oil', price: 34.99),
    ];
  }
}
